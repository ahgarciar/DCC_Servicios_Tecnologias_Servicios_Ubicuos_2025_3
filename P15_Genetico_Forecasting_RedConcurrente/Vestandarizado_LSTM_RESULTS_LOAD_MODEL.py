...
from AG_LSTM_vGuardaModelos_Estandarizado import CustomNormalization, calc_rmse, train_val_test_split, create_supervised_dataset
...
if __name__ == '__main__':
    ...
    model = load_model('Mejor_Modelo/RespaldoMejor/modelo_product_1.keras', custom_objects={
